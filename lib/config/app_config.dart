...
class AppConfig {
  // ==================== APP IDENTITY ====================
  static const String appName = 'Dadexpress Delivery';
  ...
  static const String webUrl = 'https://dadexpress.in/delivery/';
  ...
  // Notification sound name (filename without extension, should be in res/raw for Android and assets for iOS)
  ...
  static const String apiBaseUrl = 'https://api.dadexpress.in/api/';
  ...
  static const List<OnboardingPage> onboardingPages = [
    OnboardingPage(
      title: 'Welcome to Dadexpress Delivery',
      description:
          'Experience seamless delivery with the Dadexpress app.',
